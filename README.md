...
- **AI Edit** — build offline, context-rich AI edit plans for draft cards, latest-review repair, visual generation request previews, and visual analysis request previews. Plans show the project guidance, selected card/asset context, explicit patch operations, and selectable proposals before applying changes through the normal editor undo/draft flow. This pass does not call external providers or write generated image files.
