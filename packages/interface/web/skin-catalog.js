...
export const SKINS = Object.freeze([
  skin("github-light", "Github Light", "#f6f8fa", "#0969da", {
  ...
  skin("catppuccin-latte", "Catppuccin Latte", "#eff1f5", "#8839ef", {
  ...
  skin("classic", "Classic", "#10110f", "#d8a83a", {
  ...
  skin("famicom", "Famicom", "#efe4cc", "#b52222", {
  ...
  skin("phantom", "Phantom", "#09090a", "#d71920", {
  ...
  skin("arcade", "Arcade", "#15111c", "#ffd34f", {
  ...
  skin("terminal", "Terminal", "#07100c", "#68ff95", {
...
function skin(id, label, swatchBackground, swatchAccent, tokens) {
  return Object.freeze({ id, label, swatch: Object.freeze([swatchBackground, swatchAccent]), tokens: Object.freeze(tokens) });
}
