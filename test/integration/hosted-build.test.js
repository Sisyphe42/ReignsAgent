...
describe("hosted Creator build", () => {
  it("contains a scoped offline shell without server or secret artifacts", async () => {
    ...
    for (const required of ["index.html", "play.html", "manifest.webmanifest", "sw.js", "logo-alpha.png", "assets/card-artwork.js", "assets/dashboard.css", "assets/swipe-input.js"]) assert.ok(files.includes(required), `missing ${required}`);
